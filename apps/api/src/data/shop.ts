...
export const shopPaymentMethods: ShopPaymentMethod[] = [
  {
    id: 'stripe',
...
export const shopCatalogPayload: ShopCatalogPayload = {
  hero: {
...
export const shopProductsById = new Map(shopProducts.map((product) => [product.id, product]));
export const shopProductsBySlug = new Map(shopProducts.map((product) => [product.slug, product]));
