...
## Impact velocity
- **Communities served:** 48 across 6 African countries (up 28% QoQ).
- **Clean water access:** 32K daily beneficiaries through Volta corridor pilots.
...
_Talk track:_ "Payments remain Stripe-first. Future toggles for crypto and mobile money are coded but intentionally masked, signalling a disciplined rollout once we hit compliance milestones."

## Engagement signals
- **Newsletter CTR:** 38% average click-through thanks to field-story segmentation.
...
2. **18-month runway** covering core product hires (analytics engineer, partnerships lead) and local operations.
3. **Milestones:**
   - Q1: Launch mixed-payment beta (Stripe + MoMo) for recurring donors.
   - Q2: Publish regional impact dashboards with live Plausible + Stripe overlays.
   - Q3: Expand Creative Economy Studio to export collections in three markets.

_Talk track:_ "Capital accelerates both programme delivery and platform stickiness. We already own the narrative layer; your investment multiplies the reach."

_Keep this page nearby during Q&A for quick metric callouts._
